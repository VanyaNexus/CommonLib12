...
extends AbstractPacket {
    ...
    public double getVelocityX() {
        return (double) this.handle.getIntegers().read(1).intValue() / 8000.0;
    }
    ...
    public double getVelocityY() {
        return (double) this.handle.getIntegers().read(2).intValue() / 8000.0;
    }
    ...
    public double getVelocityZ() {
        return (double) this.handle.getIntegers().read(3).intValue() / 8000.0;
    }
