...
extends AbstractPacket {
    ...
    public double getOptionalSpeedX() {
        return (double) this.handle.getIntegers().read(4).intValue() / 8000.0;
    }
    ...
    public float getYaw() {
        return (float) this.handle.getIntegers().read(7).intValue() * 360.0f / 256.0f;
    }
    ...
    public float getPitch() {
        return (float) this.handle.getIntegers().read(8).intValue() * 360.0f / 256.0f;
    }
