...
public class RegionFile implements Closeable, AutoCloseable
{
    ...
    public DataOutputStream getChunkDataOutputStream(final int x, final int z) {
        ...
        if (this.outOfBounds(x, z)) {
            ...
            final BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new DeflaterOutputStream(new ChunkBuffer(x, z)));
